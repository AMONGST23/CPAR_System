...
def admin_export_records_view(request):
    ...
    fields = [
        ...
        ('last_delivery_location', 'Last Delivery Location'),
        ('home_delivery_support', 'Home Delivery Support'),
        ...
        ('prenatal_visit_count', 'Antenatal Visit/Contact'),
        ('prenatal_facility', 'Antenatal Facility/Health Facility'),
        ('weight_kg', 'Weight (kg)'),
        ('height_cm', 'Height (cm)'),
        ...
        ('benefit_saves_travel_time', 'Benefit: Save Travel Time and Cost'),
        ...
        ('referred_high_risk_pregnancy', 'Are You Referred To A Higher-Level Facility?'),
        ('referral_reason_ectopic_pregnancy', 'Referral Reason: Ectopic Pregnancy'),
        ('referral_reason_placental_abnormalities', 'Referral Reason: Placental Abnormalities'),
        ('referral_reason_amniotic_fluid_disorders', 'Referral Reason: Amniotic Fluid Disorders'),
        ('referral_reason_malpresentation', 'Referral Reason: Malpresentation'),
        ('referral_reason_uterine_pathologies', 'Referral Reason: Uterine Pathologies'),
        ('referral_reason_fetal_distress', 'Referral Reason: Fetal Distress'),
        ('referral_reason_other', 'Referral Reason: Other'),
        ('gbv_encountered', 'GBV: Encountered'),
        ('gbv_shared_concern', 'GBV: Shared or Reported Concern'),
